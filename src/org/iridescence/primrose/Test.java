...
public class Test {
  public static void main(String[] args){
    ...
    MaterialPhong materialPhong = new MaterialPhong(new Texture("./assets/container.png", GL_NEAREST_MIPMAP_NEAREST, GL_NEAREST_MIPMAP_LINEAR), new Texture("./assets/container-s.png", GL_NEAREST_MIPMAP_NEAREST, GL_NEAREST_MIPMAP_LINEAR), 1.0f, 0.7f);
    ...
    for(int i = 0; i < 1000; i++){
      ...
      cubes.transform.position = new Vector3f((float)Math.random() * 50 - 25, (float)Math.random() * 50 - 25, (float)Math.random()*50 - 25);
      cubes.transform.rotation = new Vector3f((float)Math.random() * 50 - 25, (float)Math.random() * 50 - 25, (float)Math.random()*50 - 25);

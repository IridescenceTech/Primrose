...
public class OGLUtils {
   ...
   */
  public static void oglResolveFrameBuffers(int fbo1, Vector2i fbo1Res, int fbo2, Vector2i fbo2Res){
    glBindFramebuffer(GL_DRAW_FRAMEBUFFER, fbo1);
    glBindFramebuffer(GL_READ_FRAMEBUFFER, fbo2);
    glBlitFramebuffer(0, 0, fbo2Res.x, fbo2Res.y, 0, 0, fbo1Res.x, fbo1Res.y, GL_DEPTH_BUFFER_BIT | GL_COLOR_BUFFER_BIT, GL_NEAREST);
  }
